...
![Просмотр задачи](satiafactory-task-manager/docx/View%20resources%20for%20all%20costs.png)

Настроив фильтр в “План производства” игроку дается полная информация для реализации задачи. Пользователь сразу видит сколько ему нужно построек для производства, ресурсов на все постройки, итог всех ресурсов на все постройки.

### 9. Завершение задачи после выполнения

![Просмотр задачи](satiafactory-task-manager/docx/Completing%20a%20task%20after%20it%20is%20completed.png)

Когда пользователь полностью выполняет свою задачу, он меняет её статус на “Выполнена”. Задача перемещается в “Выполненные задачи”.
